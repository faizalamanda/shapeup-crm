...
async function run() {
  const email = 'test_new_staff@gmail.com';
  const name = 'Test New Staff';
  const active_business_id = '097211f4-2d19-4196-a7b7-5b2cd17c2588'; // Alamanda

  console.log("Starting test staff insert workflow...");
  ...
  // 3. Insert to business_staff
  console.log("Inserting into business_staff...");
