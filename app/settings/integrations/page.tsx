...
export default function IntegrationsSettingsPage() {
  ...
  if (loadingActiveBusiness) {
    return (
      <SettingsLayout title="Integrasi & Plugin" subtitle="Hubungkan WooCommerce, toko e-commerce, dan API pihak ketiga.">
    ...
    <SettingsLayout title="Integrasi & Plugin" subtitle="Hubungkan WooCommerce, toko e-commerce, dan API pihak ketiga.">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-[#6B6B63]">
            Pilih dan atur integrasi platform toko online Anda di bawah ini.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-[#E2E2DC] p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-6">
          ...
          <div className="pt-4 border-t border-[#E2E2DC] flex items-center justify-between">
            ...
            <button
              onClick={() => setSelectedPlugin(wooPlugin)}
        ...
        {INTEGRATION_PLUGINS.filter(p => p.id !== 'woocommerce').map((plugin) => (
          <div 
            key={plugin.id}
