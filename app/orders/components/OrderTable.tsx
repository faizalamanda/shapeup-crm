  ...
  return (
    <div className="bg-white border border-slate-300 shadow-sm rounded overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse font-sans min-w-[1500px]">
          <thead className="bg-[#f8f9fa] border-b border-slate-300 text-[9px] uppercase text-slate-500 font-bold tracking-widest whitespace-nowrap text-center">
            <tr>
              ...
              <th className="px-4 py-3 sticky left-[52px] bg-[#f8f9fa] border-r border-slate-200 z-10 text-left">Pelanggan</th>
          ...
          <tbody className="divide-y divide-slate-100 text-[11px] text-center">
            {orders.map((o) => (
              <tr key={o.id} className="hover:bg-[#fffdf0] transition-colors group">
                ...
                <td className="px-4 py-2 text-slate-500 text-left truncate max-w-[200px]" title={o.items_detail}>
                  {o.items_detail}
                </td>
                ...
                {/* TOTAL ORDER - HIGHLIGHTED */}
                <td className="px-4 py-2 text-right font-black text-slate-900 bg-slate-50 group-hover:bg-yellow-50 border-x border-slate-200 shadow-inner">
                  {formatIDR(o.total_order)}
                </td>
                ...
                <td className="px-4 py-2">
                  <button className="bg-[#25D366] text-white p-1 rounded-sm hover:scale-110 transition-transform">
                    💬
                  </button>
                </td>
              </tr>
