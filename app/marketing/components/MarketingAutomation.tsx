...
export default function MarketingAutomation({ isModalOpen, setIsModalOpen }: any) {
  return (
    <div className="space-y-8">
      ...
      {/* TABLE LIST - Tegak & Bersih */}
      <Card>
        <div className="overflow-x-auto -m-4">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-[#f6f8fa] border-b border-gray-300">
                <th className="p-4 text-[12px] font-bold text-gray-500 uppercase tracking-wider text-nowrap">Status</th>
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-blue-50/40 transition-all cursor-pointer">
                ...
                <td className="p-4">
                  {/* Judul skenario sekarang tegak (font-bold) */}
                  <p className="font-bold text-[#0969da] text-[15px] uppercase tracking-tight leading-tight">
                    Notifikasi Order COD (OK)
                  </p>
                ...
                <td className="p-4 text-[13px] text-gray-500 text-right font-mono tracking-tighter tabular-nums text-nowrap">842 sent</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* MODAL SECTION - Tegak & Sharp */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-[#444]/40 backdrop-blur-[2px] pt-20 p-4">
          <div className="bg-white w-full max-w-xl rounded-lg shadow-2xl border border-gray-400 overflow-hidden">
            
            <div className="p-6 bg-[#f9f9f9] border-b border-gray-200 flex justify-between items-center">
              {/* Header Modal Tegak */}
              <h2 className="text-xl font-bold text-gray-800 tracking-tight uppercase">Scenario Config</h2>
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="space-y-2">
                  {/* Label tegak */}
                  <label className="text-[12px] font-bold text-gray-500 uppercase tracking-wider">Trigger Event</label>
                ...
                <div className="space-y-2">
                  <label className="text-[12px] font-bold text-gray-500 uppercase tracking-wider">Platform</label>
                  <select className="w-full p-2.5 border border-gray-300 rounded shadow-sm bg-white text-sm font-semibold outline-none focus:ring-2 focus:ring-blue-500 appearance-none">
